...
const ConsumoPage = () => {
    ...
    const handleDelete = async (id, nombreIdentificador) => {
        if (!window.confirm(`¿Estás seguro de que quieres eliminar el consumo "${nombreIdentificador}"?`)) {
            return;
        }
        try {
            await deleteConsumo(id);
            alert(`Consumo "${nombreIdentificador}" eliminado con éxito.`);
    ...
    return (
        <div className="p-12 border-b border-gray-200 bg-white sticky top-0 z-10">
            ...
            <div className="flex flex-col gap-4">
                ...
                {/* FILA 2: TODOS LOS FILTROS Y BOTONES*/}
                <div className="flex flex-wrap items-center gap-2 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    {/* 2. AUTOCOMPLETE: Selector de Dispositivo */}
                    <div className="w-56">
                        <Autocomplete
                    ...
                    <table className="min-w-full divide-y divide-gray-200 ">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="sticky top-0 bg-gray-50 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase z-10">Copias Color</th>
                                <th className="sticky top-0 bg-gray-50 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase z-10">Impr. Color</th>
                                <th className="sticky top-0 bg-yellow-100 px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase z-10">Total Color</th>
                                <th className="sticky top-0 bg-gray-50 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase z-10">Copias BW</th>
                                <th className="sticky top-0 bg-gray-50 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase z-10">Impr. BW</th>
                                <th className="sticky top-0 bg-yellow-100 px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase z-10">Total B/N</th>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {consumos.map((c) => (
                               ...
                               bg-gray-800 text-white text-xs rounded px-2 py-1 opacity-0 group-hover:opacity-100">
                                        ...
                                        {/* ELIMINAR */}
                                        <button onClick={() => handleDelete(c.idConsumo, c.nombreIdentificador)}
