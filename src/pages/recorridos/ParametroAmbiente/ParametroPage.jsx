                            ...
                            {parametros.map((p) => (
                                <tr key={p.idParametroAmbiente}>
                                    ...
                                    <td className="px-6 py-4 text-right text-sm font-medium">
                                        <button onClick={() => handleEdit(p)} className="text-indigo-600 hover:text-indigo-900 relative group"
                                        >
                               ...
                               bg-gray-800 text-white text-xs rounded px-2 py-1 opacity-0 group-hover:opacity-100">
                                        ...
                                        <button onClick={() => handleDelete(p.idParametroAmbiente, p.descripcionUbicacion)} className="text-red-600 hover:text-red-900 relative group"
                                        >
