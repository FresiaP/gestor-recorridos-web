...
export const guardarToken = (token, refreshToken) => {
  sessionStorage.setItem("token", String(token ?? "").replace(/"/g, ""));
  sessionStorage.setItem(
    "refreshToken",
    String(refreshToken ?? "").replace(/"/g, ""),
  );
};
...
export const extractErrorMessage = (
  error,
  defaultMessage = "Error de conexión o servidor.",
) => {
...
export const login = async (login, password) => {
  try {
    ...
    if (!token || !refreshToken)
      throw new Error("El servidor no proporcionó tokens.");
...
export const getUsuariosPaginados = async (
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al obtener usuarios paginados."),
    );
  }
};

export const buscarUsuarioSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const toggleUsuarioEstado = async (id, nuevoEstado) => {
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al cambiar estado de usuario."),
    );
  }
};
...
export const buscarPermisosSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const getPermisosPaginados = async (
  pagina = 1,
  tamano = 10,
  query = "",
) => {
...
export const getAsignacionesPaginadas = async (
  pagina = 1,
  tamano = 10,
  query = "",
) => {
...
export const exportarAsignaciones = async ({ query = "" }) => {
  try {
    const response = await api.get("/usuarios/asignaciones/exportar", {
      params: { query },
      responseType: "blob",
    });

    const contentDisposition = response.headers["content-disposition"];
    let fileName = "asignaciones_export.xlsx";
    if (contentDisposition) {
      const match = contentDisposition.match(/filename="?(.+)"?$/);
      if (match[1]) {
        fileName = match[1];
...
// Categoria
// ==============================================================================
export const getCategoriasPaginadas = async (
  pagina = 1,
  tamano = 10,
  query = "",
  estadoFiltro = "",
...
export const buscarCategoriasSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const updateCategoria = async (id, data) => {
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al actualizar categoría."),
    );
  }
};
export const toggleCategoriaEstado = async (id, nuevoEstado) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al cambiar estado de categoría."),
    );
  }
};
...
// Tipos
// ==============================================================================
export const getTiposPaginados = async (
  pagina = 1,
  tamano = 10,
  query = "",
  estadoFiltro = "",
...
export const buscarTiposSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const toggleTipoEstado = async (id, nuevoEstado) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al cambiar estado de tipo."),
    );
  }
};
export const deleteTipo = (id) =>
  api.delete(`/Tipo/${id}`).then((res) => res.data);
...
export const getMarcasPaginadas = async (
  ...
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al obtener marcas paginadas."),
    );
  }
};
export const buscarMarcasSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const exportarMarcas = async ({
  query = "",
  estadoFiltro = "",
} = {}) => {
  try {
...
export const toggleMarcaEstado = async (id, nuevoEstado) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al cambiar estado de marca."),
    );
  }
};
export const deleteMarca = (id) =>
  api.delete(`/marcas/${id}`).then((res) => res.data);

// ==============================================================================
// Proveedores
// ==============================================================================
export const getProveedoresPaginadas = async (
  pagina = 1,
  tamano = 10,
  query = "",
  estadoFiltro = "",
  ...
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al obtener proveedores paginados."),
    );
  }
};

export const buscarProveedoresSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const exportarProveedores = async ({
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al exportar proveedores."),
    );
  }
};
...
export const updateProveedor = async (id, data) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al actualizar proveedor."),
    );
  }
};
export const toggleProveedorEstado = async (id, nuevoEstado) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al cambiar estado de proveedor."),
    );
  }
};
export const deleteProveedor = (id) =>
  api.delete(`/proveedor/${id}`).then((res) => res.data);

// ==============================================================================
// Sitios
// ==============================================================================
export const getSitiosPaginados = async (
  pagina = 1,
  tamano = 10,
  query = "",
  estadoFiltro = "",
  ...
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al obtener sitios paginados."),
    );
  }
};

export const buscarSitiosSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const exportarSitios = async ({
  query = "",
  estadoFiltro = "",
} = {}) => {
  try {
...
export const toggleSitioEstado = async (id, nuevoEstado) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al cambiar estado del sitio."),
    );
  }
};
export const deleteSitio = (id) =>
  api.delete(`/sitios/${id}`).then((res) => res.data);

// ==============================================================================
// Contratos
// ==============================================================================
export const getContratosPaginadas = async (
  pagina = 1,
  tamano = 10,
  query = "",
  fechaInicio = null,
...
export const buscarContratosSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const updateContrato = async (id, data) => {
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al actualizar contrato."),
    );
  }
};
...
// Modelos
// ==============================================================================
export const getModelosPaginados = async (
  pagina = 1,
  tamano = 10,
  query = "",
  estadoFiltro = "",
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al obtener modelos paginados."),
    );
  }
};

export const buscarModelosSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const exportarModelos = async ({
  query = "",
  estadoFiltro = "",
} = {}) => {
  try {
...
export const toggleModeloEstado = async (id, nuevoEstado) => {
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al cambiar estado de modelo."),
    );
  }
};

export const deleteModelo = (id) =>
  api.delete(`/modelo/${id}`).then((res) => res.data);

// ==============================================================================
// Ubicaciones
// ==============================================================================
export const getUbicacionesPaginadas = async (
  pagina = 1,
  tamano = 10,
  query = "",
  estadoFiltro = "",
  ...
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al obtener ubicaciones paginadas."),
    );
  }
};

export const buscarUbicacionesSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const exportarUbicaciones = async ({
  query = "",
  estadoFiltro = "",
} = {}) => {
  try {
...
export const updateUbicacion = async (id, data) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al actualizar ubicacion."),
    );
  }
};
export const toggleUbicacionEstado = async (id, nuevoEstado) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al cambiar estado de la ubicacion."),
    );
  }
};
export const deleteUbicacion = (id) =>
  api.delete(`/ubicacion/${id}`).then((res) => res.data);
...
export const getActivosPaginados = async (
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al obtener activos paginados."),
    );
  }
};
export const buscarActivosSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const updateActivo = async (id, data) => {
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al actualizar el activo."),
    );
  }
};
export const deleteActivo = (id) =>
  api.delete(`/activos/${id}`).then((res) => res.data);
...
export const getPrediccionesPorActivo = async (idActivo) => {
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al obtener predicciones."),
    );
  }
};
...
export const generarPrediccion = async (idActivo, umbral) => {
  try {
    const response = await api.get(`/predicciones/generar/${idActivo}`, {
      params: { umbral },
    });
...
export const getServiciosPaginados = async (
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al obtener servicios paginados."),
    );
  }
};
...
export const updateServicio = async (id, data) => {
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al actualizar el servicio."),
    );
  }
};
export const deleteServicio = (id) =>
  api.delete(`/servicio/${id}`).then((res) => res.data);
...
export const getDispositivosPaginados = async (
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al obtener dispositivos paginados."),
    );
  }
};

export const buscarDispositivosSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const exportarDispositivos = async ({
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al exportar dispositivos."),
    );
  }
};
...
export const updateDispositivo = async (id, data) => {
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al actualizar el dispositivo."),
    );
  }
};

export const deleteDispositivo = (id) =>
  api.delete(`/dispositivos/${id}`).then((res) => res.data);

// ==============================================================================
// Otros Dispositivos
// ==============================================================================
export const getOtrosDispositivosPaginados = async (
  pagina = 1,
  tamano = 10,
  query = "",
  estadoFiltro = "",
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(
        error,
        "Error al obtener otros dispositivos paginados.",
      ),
    );
  }
};

export const buscarOtrosDispositivosSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const exportarOtrosDispositivos = async ({
  query = "",
  estadoFiltro = "",
} = {}) => {
  try {
...
export const getOtrosDispositivoById = (id) =>
  apiGet(`/otrosdispositivo/${id}`);
...
export const toggleOtrosDispositivoEstado = async (id, nuevoEstado) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al cambiar estado del dispositivo."),
    );
  }
};
export const deleteOtrosDispositivo = (id) =>
  api.delete(`/otrosdispositivo/${id}`).then((res) => res.data);
...
export const getConsumiblesPaginados = async (
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al obtener consumibles paginados."),
    );
  }
};
...
export const exportarConsumibles = async ({
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al exportar consumibles."),
    );
  }
};
...
export const updateConsumible = async (id, data) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al actualizar el consumible."),
    );
  }
};

export const deleteConsumible = (id) =>
  api.delete(`/consumible/${id}`).then((res) => res.data);
...
export const extraerYGuardarConsumible = async (
  ip,
  idDispositivo,
  idUsuario,
) => {
  try {
    const response = await api.post(
      "/consumible/extraer-y-guardar-consumibles",
      null,
      {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al extraer y guardar consumos."),
    );
  }
};
...
export const getConsumosPaginados = async (
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al obtener consumos paginados."),
    );
  }
};
...
export const updateConsumo = async (id, data) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al actualizar el consumo."),
    );
  }
};

export const deleteConsumo = (id) =>
  api.delete(`/consumo/${id}`).then((res) => res.data);
...
export const exportarConsumosMensuales = async ({
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al exportar consumos mensuales."),
    );
  }
};
...
export const createConsumoMensual = async (data) => {
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al crear consumo mensual."),
    );
  }
};

export const deleteConsumoMensual = (id) =>
  api.delete(`/ConsumoMensual/${id}`).then((res) => res.data);
...
export const getParametroAmbientePaginados = async (
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al obtener parámetros paginados."),
    );
  }
};
...
export const exportarParametroAmbiente = async ({
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al exportar Parametros."),
    );
  }
};

export const getParametroAmbienteById = (id) =>
  apiGet(`/ParametroAmbiente/${id}`);
...
export const updateParametroAmbiente = async (id, data) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al actualizar el parámetro."),
    );
  }
};

export const deleteParametroAmbiente = (id) =>
  api.delete(`/ParametroAmbiente/${id}`).then((res) => res.data);
...
export const getIncidenciasPaginadas = async (
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al obtener Incidencias paginadas."),
    );
  }
};

export const buscarIncidenciasSelect = async (
  inputValue = "",
  page = 1,
  size = 50,
) => {
...
export const exportarIncidencias = async ({
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al exportar incidencias."),
    );
  }
};
...
export const updateIncidencia = async (id, data) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al actualizar el incidencia."),
    );
  }
};

export const deleteIncidencia = (id) =>
  api.delete(`/Incidencias/${id}`).then((res) => res.data);
...
export const getResolucionesPaginadas = async (
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al obtener Resoluciones paginadas."),
    );
  }
};
...
export const exportarResoluciones = async ({
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al exportar resoluciones."),
    );
  }
};
...
export const updateResolucion = async (id, data) => {
  try {
    ...
    // Usando la función central
    throw new Error(
      extractErrorMessage(error, "Error al actualizar el Resolucion."),
    );
  }
};
...
export async function reasignarResolucion(idResolucion, nuevoIdIncidencia) {
  const response = await api.put(
    `/Resolucion/reasignar/${idResolucion}`,
    nuevoIdIncidencia,
    {
      headers: { "Content-Type": "application/json" },
    },
...
export const deleteResolucion = (id) =>
  api.delete(`/Resolucion/${id}`).then((res) => res.data);
...
export const getAuditoriasPaginadas = async (
  ...
  try {
    ...
    // Filtros opcionales
    if (query?.trim()) params.append("query", query.trim());
    if (moduloFiltro?.trim())
      params.append("moduloFiltro", moduloFiltro.trim());
    ...
    if (tipoBusquedaFecha?.trim())
      params.append("tipoBusquedaFecha", tipoBusquedaFecha.trim());
    ...
    throw new Error(
      extractErrorMessage(error, "Error al obtener auditorías paginadas."),
    );
  }
};
...
export const exportarAuditorias = async ({
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Error al exportar auditorías."),
    );
  }
};
...
export const exportarVencimientoContratos = async (filtro) => {
  try {
    ...
    const response = await axios.post(
      `${BASE_URL}/reportes/contratos/exportar`,
      body,
      {
        responseType: "blob",
        headers: { Authorization: `Bearer ${token}` },
    ...
    link.setAttribute(
      "download",
      `Reporte_VencimientoContrato_${new Date().toISOString().split("T")[0]}.xlsx`,
    );
    document.body.appendChild(link);
    link.click();
    link.remove();
